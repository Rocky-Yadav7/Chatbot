...
def get_response(msg):
    if msg.startswith("!movie"):
        ...
        response = "Greetings! I'm a personal chatbot created by Rocky to help answer questions about him. "
        response += "Refer below for ideas on what you can ask me :)<br><br>"
        response += "1) Get to know Rocky by asking me about his background, education, work experiences, future plans, skills, hobbies, spoken languages, birthday, age.<br><br>"
        response += "2) If you're not interested to know more about Rocky, I was built with some additional features that you might find interesting! Type !commands for more information."
